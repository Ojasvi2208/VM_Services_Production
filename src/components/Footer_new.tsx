  ...
  return (
    <footer className="bg-gradient-to-br from-brand-navy via-brand-navy to-brand-royal border-t border-brand-gold/20">
      <div className="container-padding py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-brand-pearl/90 text-sm leading-relaxed">
              Empowering financial independence through disciplined investing and transparent guidance. AMFI registered mutual fund distributor committed to your wealth creation journey.
            </p>
          ...
          <div>
            <h3 className="font-bold text-lg mb-6 text-brand-gold border-b border-brand-gold/30 pb-2">Quick Links</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/products" className="text-brand-pearl/90 hover:text-brand-gold text-sm transition-all duration-300 hover:translate-x-1 block">
                  → Our Products
                </Link>
              </li>
              <li>
                <Link href="/goal-planning" className="text-brand-pearl/90 hover:text-brand-gold text-sm transition-all duration-300 hover:translate-x-1 block">
                  → Goal Planning
                </Link>
              </li>
              <li>
                <Link href="/partners" className="text-brand-pearl/90 hover:text-brand-gold text-sm transition-all duration-300 hover:translate-x-1 block">
                  → Our Partners
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-brand-pearl/90 hover:text-brand-gold text-sm transition-all duration-300 hover:translate-x-1 block">
                  → Blog & Resources
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-brand-pearl/90 hover:text-brand-gold text-sm transition-all duration-300 hover:translate-x-1 block">
                  → About Us
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-brand-pearl/90 hover:text-brand-gold text-sm transition-all duration-300 hover:translate-x-1 block">
                  → Contact Us
                </Link>
              </li>
            </ul>
          ...
          {/* Column 3: Compliance */}
          <div>
            <h3 className="font-bold text-lg mb-6 text-brand-gold border-b border-brand-gold/30 pb-2">Compliance</h3>
            <ul className="space-y-3">
              <li>
          ...
          <div>
            <h3 className="font-bold text-lg mb-6 text-brand-gold border-b border-brand-gold/30 pb-2">Contact Info</h3>
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-3 text-brand-pearl/90 text-sm group">
                ...
                <span className="group-hover:text-brand-gold transition-colors">info@vijaymalik.com</span>
              </li>
              <li className="flex items-start space-x-3 text-brand-pearl/90 text-sm group">
                <div className="bg-brand-gold/20 p-2 rounded-lg mt-0.5">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-brand-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mt-6 p-3 bg-brand-gold/10 rounded-lg border border-brand-gold/20">
              <div className="text-center">
                <div className="text-brand-gold text-xs font-bold mb-1">AMFI REGISTERED</div>
                <div className="text-brand-pearl text-xs">ARN-317605</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Compliance Notice */}
        <div className="mt-16 bg-brand-royal/20 rounded-2xl p-6 border border-brand-gold/20">
          <ComplianceNotice type="standard" />
        </div>
        
        {/* Copyright */}
        <div className="mt-12 pt-8 border-t border-brand-gold/30 flex flex-col sm:flex-row justify-between items-center text-sm text-brand-pearl/70">
          <p className="flex items-center space-x-2">
            <span>© {currentYear} Vijay Malik Financial Services.</span>
