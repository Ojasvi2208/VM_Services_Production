        ...
        <div className="flex items-center justify-between h-16 md:h-20 px-4">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center focus-ring" aria-label="Vijay Malik Financial - Home">
              {/* Logo image - white background on homepage, transparent on other pages to blend with page background */}
              <div className={`px-3 py-2 ${pathname === '/' ? 'bg-white rounded-lg shadow-md border-2 border-gray-200' : 'bg-transparent'}`}>
                <Image 
