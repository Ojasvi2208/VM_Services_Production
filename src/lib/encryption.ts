...
//  Client-safe obfuscation helpers live in @/lib/encryption-client
//
...
// Re-export client-safe helpers so existing server-side imports still work
export { obfuscateForTransport, deobfuscateFromTransport } from '@/lib/encryption-client';
